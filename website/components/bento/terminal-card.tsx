...
const LOG_LINES = [
  "> Task: add debounced search input",
  "> Rung 1 — does this need to exist? yes",
  "> Rung 2 — stdlib does it? setTimeout/clearTimeout",
  "> Rung 3 — native feature available? no",
  "> Rung 4 — already-installed dep? no",
  "> Rung 5 — can it be one line? close",
  "> Rung 6 — writing minimum that works",
  "> 10 lines written, 0 dependencies added",
  "> dietcode: skipped reusable debounce utility",
  "> --------- CYCLE COMPLETE ---------",
]
