...
// cmd.exe-style %VAR% — it needs $env:VAR. The hook also has to point at a
// script that actually ships in hooks/. This guards both failure modes: the
// %CLAUDE_PLUGIN_ROOT% bug, and the "switch to a .ps1 that doesn't exist" one.
