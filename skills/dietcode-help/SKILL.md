...
name: dietcode-help
description: >
  Quick-reference card for all dietcode modes, skills, and commands.
  One-shot display, not a persistent mode. Trigger: /dietcode-help,
  "dietcode help", "what dietcode commands", "how do I use dietcode".
---
