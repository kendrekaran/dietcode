...
name: dietcode-debt
description: >
  Harvest every `dietcode:` comment in the codebase into a debt ledger, so the
  deliberate shortcuts and deferrals dietcode leaves behind get tracked instead
  of rotting into "later means never". Use when the user says "dietcode debt",
  "/dietcode-debt", "what did dietcode defer", "list the shortcuts", "dietcode
